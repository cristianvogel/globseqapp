...
def main():
  ...
  plistpath = scriptpath + "/resources/GlobSeqPlugIn-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/GlobSeqPlugIn-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/GlobSeqPlugIn-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/GlobSeqPlugIn-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/GlobSeqPlugIn-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/GlobSeqPlugIn.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/GlobSeqPlugIn.iss",inplace=1):
