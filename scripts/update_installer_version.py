...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=GlobSeqPlugIn Demo Installer\n"
      else:
        line="OutputBaseFilename=GlobSeqPlugIn Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the GlobSeqPlugIn Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the GlobSeqPlugIn installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=GlobSeqPlugIn Demo installer\n"
     else:
       line="SetupWindowTitle=GlobSeqPlugIn installer\n"
